        ...
        <div class="col-lg-9">
            <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    @auth()
                        <a class="btn btn-primary py-2 px-4 ml-auto d-none d-lg-block mr-1" href="{{route('posts.create')}}">Create Posts</a>
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button class="btn btn-primary py-2 px-4 ml-auto d-none d-lg-block">Logout</button>
                        </form>
                    @else
